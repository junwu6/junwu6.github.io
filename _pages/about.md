...
Dr. Jun Wu is an Assistant Professor in the [Department of Computer Science and Engineering](https://engineering.msu.edu/about/departments/cse) at [Michigan State University](https://msu.edu/) (MSU). Before joining MSU, he received his Ph.D. degree in Computer Science at University of Illinois Urbana-Champaign. He has a broad research interest in trustworthy machine learning, transfer learning/domain adaptation, and graph learning, with applications in agriculture, bioinformatics, and legal analytics. He has multiple publications at major peer-reviewed conferences and journals (e.g., ICML, AISTATS, NeurIPS, KDD, AAAI, JAIR, TKDE, etc.). He has also served as a (senior) program committee member in ML/AI conferences (e.g., ICML, NeurIPS, ICLR, AISTATS, KDD, AAAI, IJCAI, etc.).
...
* Graph machine learning, e.g., graphon theory, network of networks, etc.


*News*

* [06/2026] Invited to give a talk at the NAIRR Pilot Classroom Expansion Conference
* [04/2026] One paper has been accepted by ICML 2026! Congratulations to Xinyu Liu as the leading author.
* [04/2026] Honored to receive an Amazon research award to support our project "Investigating the Safety Landscape of LLM Scaling"
* [12/2025] Honored to receive support from the NAIRR Pilot Program for our research in modeling networked time-series
